...
Tweezy:
Tweezy the twitter rapper! Search for a popular hashtag and Tweezy will scrub twitter and make a a rap song on the fly. The propblem with Tweezy right now comes from the difficulty of forming meaningful rhyming lyrics from a slow twitter stream. This can be mitigated by storing a few thousands Tweets beforehand and preemtively indexing them agaisnt a rhyming dictionary. Updates to come.  
